...
import com.anvo.myapplication.Constant;
import com.anvo.myapplication.R;
import com.anvo.myapplication.utils.ScreenUtil;
import com.anvo.myapplication.widget.ListItemMenu;
...
public class IndexRecyclerViewAdapter extends RecyclerView.Adapter<IndexRecyclerViewAdapter.MyViewHolder> {
    ...
    public IndexRecyclerViewAdapter(List<String> datas, Context mContext) {
        this.datas = datas;
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            ...
            normalShell = itemView.findViewById(R.id.normalList);
            liveList = itemView.findViewById(R.id.liveList);
